 ...
 *  @author Kevin Wayne
 */
public class WeightedDelete {
    private int[] parent;   // parent[i] = parent of i
    private int[] smaller;     // size[i] = number of sites in subtree rooted at i
    ...
    /**
     * Returns the latest number in the component containing site {@code p}.
     *
     * @param  p the integer representing one object
     * @return the component identifier for the component containing site {@code p}
     * @throws IllegalArgumentException unless {@code 0 <= p < n}
    ...
    public void union(int p, int q) {
        ...
        if (size[rootP] < size[rootQ]) {
            ...
            if(smaller[rootP] < smaller[rootQ]){
            	smaller[rootQ] = smaller[rootP];
            }
        }
        else {
            parent[rootQ] = rootP;
    ...
    public static void main(String[] args) throws NumberFormatException, IOException {
        int n = 10;
        WeightedDelete uf = new WeightedDelete(n);
        ...
        for(int i= 0; i < n; i++){
           ...
           System.out.println("el hijo es "+i);
           System.out.println("el padre es"+ uf.root(i));
        }
